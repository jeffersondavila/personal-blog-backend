...
class ReviewDeListado(BaseModel):
    ...
    @classmethod
    def de_modelo(cls, review: BookReview, acceso: AccesoAMedios) -> ReviewDeListado:
        return cls(
            slug=review.slug,
            title=review.title,
            ...
            cover=MedioPublico.de_modelo(review.cover, acceso),
...
class ReviewDetallada(ReviewDeListado):
    ...
    @classmethod
    def de_modelo(cls, review: BookReview, acceso: AccesoAMedios) -> ReviewDetallada:
        base = ReviewDeListado.de_modelo(review, acceso)
        return cls(
            **base.model_dump(),
