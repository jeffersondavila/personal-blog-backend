...
# arranca. Desde `Task/010` ese minimo incluye el almacenamiento de objetos, y
# desde `Task/016` el origen publico del sitio.
...
os.environ["BLOG_PUBLIC_SITE_BASE_URL"] = "http://sitio.invalid"
